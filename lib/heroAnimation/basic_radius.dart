...
class Photo extends StatelessWidget {
  Photo({  Key? key,required this.photo, this.color = Colors.white,required this.onTap }) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'images/notification.png', 'Chair'),
            _buildHero(context, 'images/plugin.png', 'Binoculars'),
            _buildHero(context, 'images/worldwide.png', 'Beach ball'),
          ],
        ),
      ),
    );
